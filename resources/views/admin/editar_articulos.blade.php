...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form method="POST" action="/articles/{{ $article->id}}" class="p-4 p-md-5 border rounded-3 bg-light">
        @csrf
    @method('PATCH')

          <div class="form-floating mb-3">
            <input type="text" name="title" value="{{ old('title', optional($article)->title)}}"  id="title" class="form-control" id="floatingPassword">
